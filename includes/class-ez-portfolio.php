...
function ez_enqueue_styles_admin () {
	wp_enqueue_style('admin-css', plugin_dir_url( __FILE__ ).'../assets/css/admin.css', true, '1.0');
}
...
function ez_enqueue_scripts_frontend_js () {
	wp_enqueue_script('frontend-js', plugin_dir_url( __FILE__ ) . '../assets/js/frontend.js', array('jquery'), '2.1.5');
}
...
function ez_enqueue_styles_font_awesome_css () {
	wp_enqueue_style('font-awesome.min', plugin_dir_url( __FILE__ ) . '../assets/css/font-awesome.min.css', true, '1.5');
}
...
function ez_enqueue_styles_lightbox_css () {
	wp_enqueue_style('jquery.lightbox', plugin_dir_url( __FILE__ ) . '../assets/css/nivo-lightbox.css', true, '1.0');
	wp_enqueue_style('jquery.lightbox.theme', plugin_dir_url( __FILE__ ) . '../assets/js/themes/default/default.css', true, '1.0');
}
...
function ez_enqueue_scripts_lightbox () {
    wp_enqueue_script('jquery.lightbox', plugin_dir_url( __FILE__ ) . '../assets/js/nivo-lightbox.js', array('jquery'), '1.0');
}
...
function ez_enqueue_scripts_shuffle () {
	wp_enqueue_script('shuffle', plugin_dir_url( __FILE__ ) . '../assets/js/jquery.shuffle.min.js', array('jquery'));
	wp_enqueue_script('custom', plugin_dir_url( __FILE__ ) . '../assets/js/jquery.custom.js', array('jquery'));
	wp_enqueue_script('modernizer', plugin_dir_url( __FILE__ ) . '../assets/js/jquery.shuffle.modernizr.min.js', array('jquery'));
}
...
function ez_portfolio_add_tinymce_plugin($plugin_array) {
	$plugin_array['ez_portfolio_button'] = plugin_dir_url( __FILE__ ) . '../assets/js/shortcode.js';
	return $plugin_array;
}
